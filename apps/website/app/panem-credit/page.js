          ...
          <section className="application-notice application-notice--error">
            ...
            <p>
              {params.error === "daily-limit"
                ...
                : params.error === "recipient-not-found"
                  ? "No single matching recipient wallet was found. Use the exact public handle from the dropdown or the citizen's Discord mention."
                : params.error === "same-wallet"
                  ? "You cannot send Panem Credits to your own wallet."
                : params.error === "invalid-amount"
                  ? "Enter a transfer amount greater than zero."
                : params.error === "recipient-frozen"
                  ? "The recipient wallet is frozen and cannot receive citizen transfers."
